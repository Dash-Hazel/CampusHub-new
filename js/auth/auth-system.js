        ...
        <div class="user-info">
            ...
            <div class="user-dropdown">
                ...
                <div class="dropdown-content">
                    <a href="pages/user-dashboard.html" class="dropdown-item">📝 Моите статии</a>
                    <a href="pages/submit-article.html" class="dropdown-item">✏️ Напиши статия</a>
                    ${role === 'redactor' ? '<a href="pages/redactor-dashboard.html" class="dropdown-item">📋 Редакторски панел</a>' : ''}
